<template>
	<Nav title="管理亲友" backUrl="/pages/reminders/reminders"/>
    ...
    <scroll-view class="form-page" scroll-y>
      <view class="form-content">
        ...
        <view class="form-group">
          ...
          <input type="text" v-model="formData.nickname" class="input-field" placeholder="11" />
        </view>

        <view class="form-group">
          <text class="label">关系</text>
          <input type="text" v-model="formData.relationship" class="input-field" placeholder="朋友" />
        </view>

        <view class="form-group">
          <text class="label">手机号码</text>
          <view class="phone-input-group">
            <input type="number" v-model="formData.phone" class="input-field phone-input" placeholder="123465879"
              maxlength="11" />
        ...
        <view class="delete-link" @tap="handleDelete">删除亲友</view>
      </view>
    </scroll-view>
  </view>
</template>
